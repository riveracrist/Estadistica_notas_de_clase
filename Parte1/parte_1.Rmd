...
<center>
![**Data Science**](/home/crg/mi-carpeta/2020/estadistica/apuntes_estadistica/Parte1/imagenes/data_science_venn.jpg)
</center>
...
* Evalura la calidad y consistencia de los datos.
...
Cualquier individuo que porte información sobre el fenómeno obajo estudio.
...
Son aquellas variables que otorgan un resultado representado por un valore numérico.
...
Es el valor central, cuando se ordenan de menor a mayor los valores. La mediana deja por enciame y por debajo de ella, el $50%$ de los datos.

No se ve afectada por valores extremos. 

* En distribuciones simétricas la media es aproximadamente igual a la modiana.

* En distribuciones con sesgo a la derecha, la media tiende a ser mayor que la mediana

* En distribuciones con sego a la izquierda la media tiende a ser mayor que la mediana.
...
Es una medida apropiada cuando en un conjunto de datos cada uno de ellos tiene una importancia relativa (o peso) respecto a los demás datos. Se obtiene multiplicando cad uno de los datos por su ponderación (peso) para luego sumarlos, obteniendo así una suma ponderada, después se divide esta, entre la sima de los pesos.


### Ejemplo

Las comisiones recibidas por un corredor de bolsa durante los últimos seis meses se representan en la siguiente tabla las siguientes.

|Acción|% de ganancia|Cantidad|Total COP|
|:---:|:---:|:---:|:---:|
|x|0.03|80|1350600|
|y|0.07|35|896200|
|z|0.06|67|1056000|
...
Las notas obtenidas por cierto estudiante de bachillerato se presentan a continuación:
...
Es una interpretación relativa del grado de variabilidad independinte de la ecala de la variable.
...
Dividen la muestra en 100 partes iguales. Son los valores que dejan determindado porcentaje de observaciónes por debajo de ellos.
...
<center>    
![Cuartil](/home/crg/mi-carpeta/2020/estadistica/apuntes_estadistica/Parte1/imagenes/cuartil.png)  
</center>
...
Donde se ubica el mínimo valor, es el límite inferior ($L_i$); y para la posición del máximo valor se tiene el ímite superior ($L_s$).
...
<center>
![RIQ](/home/crg/mi-carpeta/2020/estadistica/apuntes_estadistica/Parte1/imagenes/RIQ.png)  
</center>
...
* Nombrar tablas y enumerarlas
* Enumarar ecuaciones
* Enumerar y nombrara gráficos
* Agregar ejemplos para moda , media, media.
